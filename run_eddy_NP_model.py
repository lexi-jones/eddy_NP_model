...
from model_functions_project_v2 import reformat_1D_to_2D,FE_upwind_2D_adv_diff_eddy_NP_model,FE_upwind_2D_adv_diff_eddy_NPP_model
...
if (P_combo == 'S') or (P_combo == 'L'): # one phytoplankton
    numP = 1
    P_mat,N_mat,psi_mat,N_star,P_star = FE_upwind_2D_adv_diff_eddy_NP_model(Lx,Ly,del_x,del_y,del_t,num_steps,alter_vort,death_rate)
...
def animate_NP(i):
    ...
    phyto.set_array((all_P[0][i*skip,1:-1,1:-1]/1000).ravel())
